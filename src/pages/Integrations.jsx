import integrationIcon from '../assets/Image/Code.png'
function Integrations() {
    return (
        <div className="flex min-h-screen w-full max-w-[1200px] mx-auto flex-col">
            {/* Header giống như "Detailed Report" */}
            <div className="flex items-center space-x-2 px-6 py-4">
                <img src={integrationIcon} alt="Project Icon" className="w-5 h-5" />
                <h3 className="font-semibold text-lg text-gray-800">Integration</h3>
            </div>
